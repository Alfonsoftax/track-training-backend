...
import static com.track.training.app.customer.config.Constants.MAX_IN_VALUES;
...
import com.track.training.app.general.TransactionType;
import com.track.training.app.interfaces.CustomQuery;
import com.track.training.app.interfaces.CustomQueryDslPredicateExecutor;
import com.track.training.app.interfaces.CustomQueryFunction;
 ...
 */
public abstract class DefaultServiceImpl<T extends DomainEntity<I>, I extends Serializable, F extends Serializable, //
    ...
    protected DefaultServiceImpl(final R repository) {
    ...
    protected void validate(final T entity, final GeneralData generalData) { // NOSONAR
        // To override
    }
