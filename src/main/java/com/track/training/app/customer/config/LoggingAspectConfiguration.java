...
public class LoggingAspectConfiguration {
    ...
    public static class LoggingAspect {
         ...
         */
        @Pointcut("within(com.track.training.app.customer.core.implementation..*)"
                + " || within(com.track.training.app.customer.infrastructure..*)"
                + " || within(com.track.training.app.customer.adapters..*)")
