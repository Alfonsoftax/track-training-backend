...
import com.src.train.track.general.domain.Coordinates;
import com.src.train.track.general.domain.DomainEntityCode;
...
public final class PredicateBuilder implements Predicate {
    ...
    public PredicateBuilder coordinates(final StringExpression coordinateXExpression,
            final StringExpression coordinateYExpression, final StringExpression coordinateZExpression,
            final Coordinates coordinatesFrom, final Coordinates coordinatesTo) {
        if (coordinatesFrom != null || coordinatesTo != null) {
            String coordinateXStart = null;
            String coordinateXEnd = null;

            String coordinateYStart = null;
            String coordinateYEnd = null;

            String coordinateZStart = null;
            String coordinateZEnd = null;

            if (coordinatesFrom != null) {
                coordinateXStart = coordinatesFrom.getCoordinateX();
                coordinateYStart = coordinatesFrom.getCoordinateY();
                coordinateZStart = coordinatesFrom.getCoordinateZ();
            }

            if (coordinatesTo != null) {
                coordinateXEnd = coordinatesTo.getCoordinateX();
                coordinateYEnd = coordinatesTo.getCoordinateY();
                coordinateZEnd = coordinatesTo.getCoordinateZ();
            }

            this.range(coordinateXExpression, coordinateXStart, coordinateXEnd, 3);
            this.range(coordinateYExpression, coordinateYStart, coordinateYEnd, 3);
            this.range(coordinateZExpression, coordinateZStart, coordinateZEnd, 3);
        }
        return this;
    }
