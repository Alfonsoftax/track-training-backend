...
public class LoggingAspectConfiguration {
    ...
    public static class LoggingAspect {
         ...
         */
        @Pointcut("within(com.izertis.architecture.examples.customer.core.implementation..*)"
                + " || within(com.izertis.architecture.examples.customer.infrastructure..*)"
                + " || within(com.izertis.architecture.examples.customer.adapters..*)")
