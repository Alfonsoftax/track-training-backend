// formatter:off
package com.izertis.architecture.examples.customer;
...
@AnalyzeClasses(packages = "com.izertis.architecture.examples.customer", importOptions = DoNotIncludeTests.class)
class ArchitectureTest {
    ...
    static final ArchRule respectsLayersForHexagonalArchitecture = layeredArchitecture()
        .consideringOnlyDependenciesInAnyPackage("com.izertis.architecture.examples.customer..")
        .layer("Any").definedBy("..")
